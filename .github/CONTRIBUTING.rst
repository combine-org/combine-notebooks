...
Report bugs at https://github.com/combine-org/combine-notebooks/issues.
...
combine_notebooks could always use more documentation, whether as part of the official
...
https://github.com/matthiaskoenig/combine_notebooks/issues.
...
Ready to contribute? Here's how to set up combine_notebooks for local development.

1. Fork the https://github.com/matthiaskoenig/combine_notebooks repository on GitHub. If you
...
3. Install your local copy into a a Python virtual environment. You can `read
   ...
   .. code-block:: console
       ...
       mkvirtualenv combine_notebooks
       cd combine_notebooks/
...
6. When you're done making changes, check that your changes pass our test suite.
   ...
   .. code-block:: console
       ...
       isort src/combine_notebooks
       black src/combine_notebooks
...
For larger features that you want to work on collaboratively with other combine_notebooks
team members, you may consider to first request to join the combine_notebooks developers
...
1. The pull request should include tests in the ``combine_notebooks/test``
...
4. Someone from the @matthiaskoenig/combine_notebooks-core team will review your work and guide
   you to a successful contribution.

Unit tests and benchmarks
-------------------------

combine_notebooks uses `pytest <http://docs.pytest.org/en/latest/>`_ for its
unit-tests and new features should in general always come with new
tests that make sure that the code runs as intended. 

To run all tests do::

    (combine_notebooks)$ pytest
...
Thank you very much for contributing to combine_notebooks!
